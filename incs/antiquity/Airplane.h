...
class Airplane: public Object {
  ...
  private:
    void readVertices() {
      ...
      p_ply ply = ply_open(
          "incs/antiquity/objects/airoplane.ply", NULL, 0, NULL);
      ...
      const mat4 transform = Translate(-0.35, -0.02, 0.42)
          * RotateX(120.0) * Scale(scaleF, scaleF, scaleF)
  ...
  public:
    ...
    void idle( void ) {
      if (autoOnOff != 0) {
        my_model_view = my_model_view * Translate(-0.35, -0.02, 0.42)
            * RotateY(0.5) * Translate(0.35, 0.02, -0.42);
      }
      glutPostRedisplay();
    }
